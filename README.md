...
Se inicia con la lectura de la señal original, la señal filtrada y la frecuencia de muestreo, se define el intervalo de tiempo que se debe analizar teniendo en cuenta que debe ser suficiente para el análisis de la señal para este caso se escogió el intervalo entre los 139 - 140 segundos.  Después de definir estos parámetros se procede con la creación de las dos gráficas señal original y señal filtrada  dando como resultado:
